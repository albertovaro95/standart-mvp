...
## Context
You're participating in a hackathon with **2 hours** to ideate and prototype from scratch. The theme will be revealed on-site. You need to quickly validate an idea and define a minimal MVP that can be prototyped in the remaining time.

## Input
Product Idea: $ARGUMENTS

## Step 1: Quick Problem Validation (5 min)
...
## Step 2: Rapid Research & Discovery (10 min)
...
- **Technical feasibility**: Can this be prototyped in ~1.5 hours? (High-level assessment)

## Step 3: Core Hypothesis & MVP Definition (10 min)
...
## Step 4: Quick Validation Plan (5 min)
...
- **Time estimate**: Can we build the MVP in ~1.5 hours?
...
- **Focus on demo-ability**: Can we show value in a 2-minute demo?
- **Time-box everything**: Each step has a time limit - stick to it
...
- Research & Discovery: 10 min
- MVP Definition: 10 min
- Validation Plan: 5 min
- Documentation: 5 min
- **Total: ~35 minutes** (leaving ~1.5 hours for prototyping)
